...
namespace bomberman {
    ...
    void SceneManager::CreateMenuScene() {
        ...
        menu->AddEntity(new GamePlayer("../Assets/AnimalsCharacters/Gazelle.iqm",
                                       ...
                                       gameRef, 1, 0.1f));
        menu->AddEntity(new GameText("../Assets/Font/Beauty_Forest.free.ttf",
                                     "Forest Bomberman",
                                     525, 100, 200, WHITE));
        menu->AddEntity(new GameText("../Assets/Font/Beauty_Forest.free.ttf",
                                     "Press Enter To Play",
    ...
    void SceneManager::CreateLevelScene() {
        ...
        level->AddEntity(new GameText("../Assets/Font/Beauty_Forest.free.ttf",
                                      "Level 1",
                                      875,
                                      80,
                                      125,
        ...
        for (int y = 0; y < 2; y++) {
            for (int x = 0; x < 3; x++) {
                level->AddEntity(new GameImage("../Assets/Heart/little_life.png",
                                               10 + 100 * x,
                                               100 + 800 * y));
                level->AddEntity(new GameImage("../Assets/Heart/little_life.png",
                                               1610 + 100 * x,
    ...
    void SceneManager::CreateSettingsScene() {
        ...
        settings->AddEntity(new GameButton(850,
                                           500,
                                           "../Assets/Buttons/darkmode.png",
                                           "../Assets/Buttons/lightmode.png"));
